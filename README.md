...
### 🛠 Technical Skills
* **Languages:** C (Embedded), C++, ARM/MIPS Assembly, Python, Verilog.
* **Embedded Ecosystem:** nRF Connect, PSoC, STM32CubeIDE, RTOS Fundamentals, Interrupt-Driven Systems.
* **Protocols:** UART, SPI, I2C, BLE, CAN, USB, Memory-Mapped I/O.
* **Design & Simulation:** MATLAB/Simulink, Altium Designer, LTspice, Multisim, Quartus (Intel/Altera).
* **Test & Validation:** Logic Analyzers, Oscilloscopes, JTAG/SWD, LabVIEW.
...
* Designed and fabricated an analog front-end PCB for accurate bioelectrode sensing and low-noise signal conditioning.
* Managed the full lifecycle from schematics and Gerber files in Multisim to physical board validation.
...
* Managed complex electronic and networking fault resolution for fiber and IP-based services.
...
### 📫 Connect with Me
* **LinkedIn:** [linkedin.com/in/ugonnaejimole](https://www.linkedin.com/in/ugonnaejimole)
